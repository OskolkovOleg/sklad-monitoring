...
export function KPICard({ title, value, subtitle, icon, trend, color = 'blue' }: KPICardProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6 hover:border-[#00D632] hover:shadow-md transition-all duration-300">
            ...
            <div className="flex items-center mt-2">
              <span
                className={`text-sm font-medium ${
                  trend.isPositive ? 'text-[#00D632]' : 'text-red-600'
                }`}
              >
